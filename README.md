...
&emsp;Add the given SQL code line to your hero.sql file to create a tables. refer to sample output from instructions.txt
&emsp;CREATE TABLE ...

&emsp;Add and commit the changes to the "feat/create-tables" branch:
&emsp;git status
&emsp;git add hero.sql
&emsp;git commit -m "feat create tables syntax"

&emsp;Switch back to the main branch
&emsp;git checkout main

&emsp;Merge the changes from the feat/create-tables feature branch into the main branch
&emsp;git merge -m "feat added create database" feat/create-tables
